...
STRUCTURED_TESTS = [
    ...
    # Sapaan + Compound (sebagai satu token card)
    {
    ...
    {
        "input": ["Selamat Pagi", "Saya", "Belajar"],
        "token_types": ["SIGN", "SIGN", "SIGN"],
        "references": ["Selamat pagi! Saya sedang belajar.", "Selamat pagi! Saya belajar."]
    },
    {
        "input": ["Selamat Siang", "Apa Kabar"],
        "token_types": ["SIGN", "SIGN"],
        "references": ["Selamat siang! Apa kabar?", "Siang! Apa kabar?"]
    },
    {
        "input": ["Halo", "Saya", "Terima Kasih"],
        "token_types": ["SIGN", "SIGN", "SIGN"],
        "references": ["Halo! Saya. Terima kasih!", "Halo! Terima kasih!"]
    },
    # Pertanyaan (WH) - menggunakan label yang ada
    {
        "input": ["Siapa", "Dia"],
        "token_types": ["SIGN", "SIGN"],
    ...
    {
        "input": ["Apa", "Kamu", "Makan"],
        "token_types": ["SIGN", "SIGN", "SIGN"],
        "references": ["Kamu sedang makan apa?", "Kamu makan apa?"]
    },
    # Kalimat Kompleks (3+ token) - hanya label resmi
    {
    ...
    {
        "input": ["Selamat Sore", "Kamu", "Baik"],
        "token_types": ["SIGN", "SIGN", "SIGN"],
        "references": ["Selamat sore! Kamu baik.", "Sore! Kamu baik."]
    },
    {
        "input": ["Selamat Malam", "Terima Kasih"],
        "token_types": ["SIGN", "SIGN"],
        "references": ["Selamat malam! Terima kasih!", "Malam! Terima kasih!"]
    },
]
...
RANDOM_TESTS = [
    ...
    # Reversed dengan compound card (token valid)
    {
        "input": ["Apa Kabar", "Halo"],
        "token_types": ["SIGN", "SIGN"],
        "references": ["Halo! Apa kabar?", "Hai! Apa kabar?"]
    },
    {
        "input": ["Terima Kasih", "Halo"],
        "token_types": ["SIGN", "SIGN"],
        "references": ["Halo! Terima kasih!", "Hai! Terima kasih!"]
    },
    {
        "input": ["Makan", "Apa", "Kamu"],
        "token_types": ["SIGN", "SIGN", "SIGN"],
        "references": ["Kamu sedang makan apa?", "Kamu makan apa?"]
    },
    {
        "input": ["Tidur", "Dia", "Siapa"],
        "token_types": ["SIGN", "SIGN", "SIGN"],
        "references": ["Siapa dia tidur?", "Siapa yang tidur?"]
    },
